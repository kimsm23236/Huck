...
Shader "TidalFlask/Top Projection URP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 break109 = WorldPosition;
				float2 appendResult113 = (float2(break109.x , break109.z));
				float4 lerpResult62 = lerp( float4( desaturateVar131 , 0.0 ) , ( _TopTextureTint * tex2D( _TopTexture, (appendResult113*_TopTextureTiling + 0.0) ) ) , pow( saturate( ( WorldNormal.y + _CoverageAmount ) ) , _CoverageFalloff ));
				
				float3 Albedo = lerpResult62.rgb;
...
/*ASEBEGIN
Version=18912
2168;19;1386;984;3933.518;1575.7;3.0234;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;91;-2297.292,152.0532;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;71;-2088.219,701.8334;Float;False;Property;_CoverageAmount;Coverage Amount;6;0;Create;True;0;0;0;False;0;False;-0.15;-0.18;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;124;-2055.185,523.326;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;96;-1731.108,524.0688;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-1742.971,703.5007;Float;False;Property;_CoverageFalloff;Coverage Falloff;7;0;Create;True;0;0;0;False;0;False;0.5;0.65;0.01;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;132;-1334.563,-711.8544;Inherit;False;Property;_BaseTextureSaturation;Base Texture Saturation;2;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;108;-1571.108,524.0688;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;115;-1411.108,524.0688;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;118;-1235.107,524.0688;Inherit;False;FLOAT;1;0;FLOAT;0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
WireConnection;138;4;61;0
ASEEND*/
//CHKSM=CFC0C10E49920CF62DFF7D940E69ECFDDEE01868